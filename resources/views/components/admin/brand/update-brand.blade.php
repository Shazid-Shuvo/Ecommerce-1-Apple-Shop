...
<script>
    ...
    async function update() {
        ...
        let brandImgUpdate = document.getElementById('productImgUpdate').files[0];
        ...
        if (brandNameUpdate.length === 0) {
            ...
            formData.append('image',brandImgUpdate)
            ...
            showLoader();
            let res = await axios.post("/UpdateBrand",formData,config)
            hideLoader();
